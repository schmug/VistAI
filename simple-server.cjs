//================================================================
// Ultra-Simple AI Search Engine - CommonJS version
// No dependencies, no WebSockets, no module conflicts
//================================================================
...
// Read HTML file once at startup to avoid repeated disk reads
let indexHtml = `
<!DOCTYPE html>
<html>
<head>
